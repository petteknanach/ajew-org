...
BATCH = [
    # Next 40 teachings after Love 1-18 and Faith 1-22.
    {'topic': 4, 'slug': 'faith', 'title': 'Faith / אֱמוּנָה', 'segments': list(range(23, 63))},
]
...
for spec in BATCH:
    ...
    manifest={
        ...
        'collection':collection,'generated':'2026-07-08',
