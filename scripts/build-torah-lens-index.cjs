...
const EVENT_TYPES = [
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Drawing peace into the world — peace is the vessel for all blessing and sweetens harsh judgments', url: '/reader/likutay-moharan/1/14' },
      { book: 'likutay-moharan', part: 1, torah: 2, title: 'Likutay Moharan 2', titleHe: 'ליקוטי מוהר"ן ב\'', desc: 'Prayer is the weapon of Mashiach — through prayer one can sweeten all judgments at their root', url: '/reader/likutay-moharan/1/2' },
      { book: 'likutay-moharan', part: 1, torah: 5, title: 'Likutay Moharan 5', titleHe: 'ליקוטי מוהר"ן ה\'', desc: 'Joy transforms strict judgments (dinim) — through holy joy one can convert judgment to mercy', url: '/reader/likutay-moharan/1/5' },
      { book: 'likutay-moharan', part: 1, torah: 10, title: 'Likutay Moharan 10', titleHe: 'ליקוטי מוהר"ן י\'', desc: 'The Tzaddik sweetens judgments — how the righteous leader elevates harsh decrees', url: '/reader/likutay-moharan/1/10' },
      { book: 'likutay-moharan', part: 1, torah: 250, title: 'Likutay Moharan 250', titleHe: 'ליקוטי מוהר"ן ר"נ', desc: 'Fire of controversy and its rectification through truth', url: '/reader/likutay-moharan/1/250' },
      { book: 'likutay-tefilos', part: 1, torah: 14, title: 'Likutay Tefilos 14', titleHe: 'ליקוטי תפילות י"ד', desc: 'Prayer for peace in the world and sweetening of harsh judgments', url: '/reader/likutay-tefilos/1/14' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 8, title: 'Likutay Moharan 8', titleHe: 'ליקוטי מוהר"ן ח\'', desc: 'The Teyva (Ark/Word) — entering the words of prayer as Noah entered the Ark, a shelter from the flood of worldly confusion', url: '/reader/likutay-moharan/1/8' },
      { book: 'likutay-moharan', part: 1, torah: 56, title: 'Likutay Moharan 56', titleHe: 'ליקוטי מוהר"ן נ"ו', desc: 'The melody of water — how the song of creation flows through all of nature', url: '/reader/likutay-moharan/1/56' },
      { book: 'likutay-moharan', part: 2, torah: 8, title: 'Likutay Moharan II 8', titleHe: 'ליקוטי מוהר"ן תניינא ח\'', desc: 'The great teaching on faith — every person must cross the narrow bridge of life without fear', url: '/reader/likutay-moharan/2/8' },
      { book: 'likutay-moharan', part: 1, torah: 64, title: 'Likutay Moharan 64', titleHe: 'ליקוטי מוהר"ן ס"ד', desc: 'Coming to Pharaoh (the source of chaos) — confronting the deepest places of concealment', url: '/reader/likutay-moharan/1/64' },
      { book: 'likutay-tefilos', part: 1, torah: 8, title: 'Likutay Tefilos 8', titleHe: 'ליקוטי תפילות ח\'', desc: 'Prayer to be saved from the floodwaters of confusion and to find the holy words', url: '/reader/likutay-tefilos/1/8' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 2, title: 'Likutay Moharan 2', titleHe: 'ליקוטי מוהר"ן ב\'', desc: 'Prayer is the weapon of Mashiach — the ultimate victory comes through prayer, not physical warfare', url: '/reader/likutay-moharan/1/2' },
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Drawing peace into the world — raising God\'s honor to its root brings universal peace', url: '/reader/likutay-moharan/1/14' },
      { book: 'likutay-moharan', part: 1, torah: 75, title: 'Likutay Moharan 75', titleHe: 'ליקוטי מוהר"ן ע"ה', desc: 'Wars come from dispute among Torah scholars — the spiritual root of physical conflict', url: '/reader/likutay-moharan/1/75' },
      { book: 'likutay-moharan', part: 2, torah: 44, title: 'Likutay Moharan II 44', titleHe: 'ליקוטי מוהר"ן תניינא מ"ד', desc: 'The importance of praying for peace and for the welfare of the nation', url: '/reader/likutay-moharan/2/44' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Tiku Emunah — the blast of faith that shatters all barriers and brings the ultimate redemption', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-tefilos', part: 1, torah: 2, title: 'Likutay Tefilos 2', titleHe: 'ליקוטי תפילות ב\'', desc: 'Prayer for the power of prayer to overcome all enemies', url: '/reader/likutay-tefilos/1/2' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 2, torah: 5, title: 'Likutay Moharan II 5', titleHe: 'ליקוטי מוהר"ן תניינא ה\'', desc: 'The world stands on emunah (faith) — when faith weakens, the very foundations tremble', url: '/reader/likutay-moharan/2/5' },
      { book: 'likutay-moharan', part: 1, torah: 64, title: 'Likutay Moharan 64', titleHe: 'ליקוטי מוהר"ן ס"ד', desc: 'Approaching the source of concealment — finding God even in the deepest darkness', url: '/reader/likutay-moharan/1/64' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Emunah is the foundation — all of creation is sustained by faith', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-moharan', part: 1, torah: 4, title: 'Likutay Moharan 4', titleHe: 'ליקוטי מוהר"ן ד\'', desc: 'The Tzaddik is the foundation of the world (Yesod Olam)', url: '/reader/likutay-moharan/1/4' },
      { book: 'likutay-tefilos', part: 2, torah: 5, title: 'Likutay Tefilos II 5', titleHe: 'ליקוטי תפילות ח"ב ה\'', desc: 'Prayer to strengthen faith when the world feels unstable', url: '/reader/likutay-tefilos/2/5' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 2, torah: 7, title: 'Likutay Moharan II 7', titleHe: 'ליקוטי מוהר"ן תניינא ז\'', desc: 'Livelihood depends on da\'at (holy knowledge) — the more connected to Hashem, the easier sustenance flows', url: '/reader/likutay-moharan/2/7' },
      { book: 'likutay-moharan', part: 1, torah: 13, title: 'Likutay Moharan 13', titleHe: 'ליקוטי מוהר"ן י"ג', desc: 'Charity opens the gates of sustenance — giving tzedakah is the key to receiving blessing', url: '/reader/likutay-moharan/1/13' },
      { book: 'likutay-moharan', part: 1, torah: 23, title: 'Likutay Moharan 23', titleHe: 'ליקוטי מוהר"ן כ"ג', desc: 'Through joy one draws down abundance — sadness constricts the channels of blessing', url: '/reader/likutay-moharan/1/23' },
      { book: 'likutay-moharan', part: 1, torah: 69, title: 'Likutay Moharan 69', titleHe: 'ליקוטי מוהר"ן ס"ט', desc: 'Desire for money pulls a person away from holiness — the rectification of financial desire', url: '/reader/likutay-moharan/1/69' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Everything depends on emunah — faith sustains even through financial hardship', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-tefilos', part: 2, torah: 7, title: 'Likutay Tefilos II 7', titleHe: 'ליקוטי תפילות ח"ב ז\'', desc: 'Prayer for honest livelihood and freedom from financial worry', url: '/reader/likutay-tefilos/2/7' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 2, torah: 24, title: 'Likutay Moharan II 24', titleHe: 'ליקוטי מוהר"ן תניינא כ"ד', desc: 'It is a great mitzvah to be joyful always — joy is the foundation of health and spiritual life', url: '/reader/likutay-moharan/2/24' },
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Peace and healing are connected — where there is peace, there is wholeness (shleimut)', url: '/reader/likutay-moharan/1/14' },
      { book: 'likutay-moharan', part: 2, torah: 3, title: 'Likutay Moharan II 3', titleHe: 'ליקוטי מוהר"ן תניינא ג\'', desc: 'Finding the good points — searching for merit even in times of suffering brings spiritual healing', url: '/reader/likutay-moharan/2/3' },
      { book: 'likutay-moharan', part: 1, torah: 31, title: 'Likutay Moharan 31', titleHe: 'ליקוטי מוהר"ן ל"א', desc: 'The song of healing — the ten kinds of melody contain the power to heal body and soul', url: '/reader/likutay-moharan/1/31' },
      { book: 'likutay-moharan', part: 1, torah: 277, title: 'Likutay Moharan 277', titleHe: 'ליקוטי מוהר"ן רע"ז', desc: 'Medicine and healing — understanding the spiritual roots of physical remedies', url: '/reader/likutay-moharan/1/277' },
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 56, title: 'Likutay Moharan 56', titleHe: 'ליקוטי מוהר"ן נ"ו', desc: 'The concept of Malkhut (sovereignty) — understanding leadership, authority, and the songs of creation', url: '/reader/likutay-moharan/1/56' },
      { book: 'likutay-moharan', part: 1, torah: 77, title: 'Likutay Moharan 77', titleHe: 'ליקוטי מוהר"ן ע"ז', desc: 'Hashem will be King over all the earth — revealing divine sovereignty through Torah and prayer', url: '/reader/likutay-moharan/1/77' },
      { book: 'likutay-moharan', part: 1, torah: 6, title: 'Likutay Moharan 6', titleHe: 'ליקוטי מוהר"ן ו\'', desc: 'Repentance and honor — how teshuvah restores fallen honor and rectifies leadership', url: '/reader/likutay-moharan/1/6' },
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Raising God\'s honor to its root — the connection between true honor and peace', url: '/reader/likutay-moharan/1/14' },
      { book: 'likutay-moharan', part: 2, torah: 7, title: 'Likutay Moharan II 7', titleHe: 'ליקוטי מוהר"ן תניינא ז\'', desc: 'Honor and knowledge — when leaders lack true knowledge, governance falters', url: '/reader/likutay-moharan/2/7' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 4, title: 'Likutay Moharan 4', titleHe: 'ליקוטי מוהר"ן ד\'', desc: 'The Tzaddik is the foundation of the world — the righteous leader sustains and elevates the entire generation', url: '/reader/likutay-moharan/1/4' },
      { book: 'likutay-moharan', part: 1, torah: 61, title: 'Likutay Moharan 61', titleHe: 'ליקוטי מוהר"ן ס"א', desc: 'The power of the Tzaddik\'s teachings endures beyond physical death', url: '/reader/likutay-moharan/1/61' },
      { book: 'likutay-moharan', part: 1, torah: 66, title: 'Likutay Moharan 66', titleHe: 'ליקוטי מוהר"ן ס"ו', desc: 'Understanding death and the eternal nature of the soul', url: '/reader/likutay-moharan/1/66' },
      { book: 'likutay-moharan', part: 2, torah: 8, title: 'Likutay Moharan II 8', titleHe: 'ליקוטי מוהר"ן תניינא ח\'', desc: 'The world is a narrow bridge — do not fear death, for the soul lives on eternally', url: '/reader/likutay-moharan/2/8' },
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 64, title: 'Likutay Moharan 64', titleHe: 'ליקוטי מוהר"ן ס"ד', desc: 'Come to Pharaoh — finding God even in the deepest concealment and darkest evil', url: '/reader/likutay-moharan/1/64' },
      { book: 'likutay-moharan', part: 2, torah: 8, title: 'Likutay Moharan II 8', titleHe: 'ליקוטי מוהר"ן תניינא ח\'', desc: 'The world is a narrow bridge — do not be afraid; fear is the real enemy', url: '/reader/likutay-moharan/2/8' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Faith pierces through all darkness — emunah is the light that no evil can extinguish', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-moharan', part: 1, torah: 5, title: 'Likutay Moharan 5', titleHe: 'ליקוטי מוהר"ן ה\'', desc: 'Joy transforms harsh judgment — even in suffering, finding the spark of holiness', url: '/reader/likutay-moharan/1/5' },
      { book: 'likutay-moharan', part: 2, torah: 12, title: 'Likutay Moharan II 12', titleHe: 'ליקוטי מוהר"ן תניינא י"ב', desc: 'There are those who go through the greatest darkness yet emerge into the greatest light', url: '/reader/likutay-moharan/2/12' },
      { book: 'likutay-tefilos', part: 2, torah: 1, title: 'Likutay Tefilos II 1', titleHe: 'ליקוטי תפילות ח"ב א\'', desc: 'Prayer for faith and strength when facing terror and tragedy', url: '/reader/likutay-tefilos/2/1' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 52, title: 'Likutay Moharan 52', titleHe: 'ליקוטי מוהר"ן נ"ב', desc: 'Gratitude and praise to Hashem in all circumstances — recognizing providence even in calamity', url: '/reader/likutay-moharan/1/52' },
      { book: 'likutay-moharan', part: 2, torah: 5, title: 'Likutay Moharan II 5', titleHe: 'ליקוטי מוהר"ן תניינא ה\'', desc: 'Emunah — faith that everything Hashem does is for the good, even what we cannot understand', url: '/reader/likutay-moharan/2/5' },
      { book: 'likutay-moharan', part: 1, torah: 56, title: 'Likutay Moharan 56', titleHe: 'ליקוטי מוהר"ן נ"ו', desc: 'Each blade of grass sings its song — nature itself contains divine praise and purpose', url: '/reader/likutay-moharan/1/56' },
      { book: 'likutay-moharan', part: 1, torah: 5, title: 'Likutay Moharan 5', titleHe: 'ליקוטי מוהר"ן ה\'', desc: 'Sweetening harsh judgments through joy — transforming gevurah (strictness) into chesed (kindness)', url: '/reader/likutay-moharan/1/5' },
      { book: 'likutay-moharan', part: 2, torah: 8, title: 'Likutay Moharan II 8', titleHe: 'ליקוטי מוהר"ן תניינא ח\'', desc: 'The whole world is a narrow bridge — courage and faith in times of danger', url: '/reader/likutay-moharan/2/8' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 47, title: 'Likutay Moharan 47', titleHe: 'ליקוטי מוהר"ן מ"ז', desc: 'Nourishment of body and soul — the connection between physical eating and spiritual elevation', url: '/reader/likutay-moharan/1/47' },
      { book: 'likutay-moharan', part: 1, torah: 62, title: 'Likutay Moharan 62', titleHe: 'ליקוטי מוהר"ן ס"ב', desc: 'Crying out to Hashem in times of need — prayers for sustenance and provision', url: '/reader/likutay-moharan/1/62' },
      { book: 'likutay-moharan', part: 2, torah: 7, title: 'Likutay Moharan II 7', titleHe: 'ליקוטי מוהר"ן תניינא ז\'', desc: 'Livelihood and sustenance — understanding the spiritual channels of provision', url: '/reader/likutay-moharan/2/7' },
      { book: 'likutay-moharan', part: 1, torah: 13, title: 'Likutay Moharan 13', titleHe: 'ליקוטי מוהר"ן י"ג', desc: 'Tzedakah (charity) sweetens harsh decrees and draws down blessing', url: '/reader/likutay-moharan/1/13' },
      { book: 'likutay-moharan', part: 1, torah: 17, title: 'Likutay Moharan 17', titleHe: 'ליקוטי מוהר"ן י"ז', desc: 'Eating in holiness elevates the sparks of creation', url: '/reader/likutay-moharan/1/17' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 51, title: 'Likutay Moharan 51', titleHe: 'ליקוטי מוהר"ן נ"א', desc: 'Truth and falsehood — the power of truth to overcome all deception', url: '/reader/likutay-moharan/1/51' },
      { book: 'likutay-moharan', part: 1, torah: 64, title: 'Likutay Moharan 64', titleHe: 'ליקוטי מוהר"ן ס"ד', desc: 'Faith, truth, and repentance — the spiritual roots of honesty and integrity', url: '/reader/likutay-moharan/1/64' },
      { book: 'likutay-moharan', part: 1, torah: 6, title: 'Likutay Moharan 6', titleHe: 'ליקוטי מוהר"ן ו\'', desc: 'Teshuvah restores what sin has corrupted — repentance is available to everyone', url: '/reader/likutay-moharan/1/6' },
      { book: 'likutay-moharan', part: 1, torah: 10, title: 'Likutay Moharan 10', titleHe: 'ליקוטי מוהר"ן י\'', desc: 'True judgment and humility — how justice must be administered with mercy', url: '/reader/likutay-moharan/1/10' },
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 1, title: 'Likutay Moharan 1', titleHe: 'ליקוטי מוהר"ן א\'', desc: 'Contemplating the intellect in all things — finding divine wisdom in every aspect of creation', url: '/reader/likutay-moharan/1/1' },
      { book: 'likutay-moharan', part: 1, torah: 64, title: 'Likutay Moharan 64', titleHe: 'ליקוטי מוהר"ן ס"ד', desc: 'The depths of wisdom and understanding — seeking truth beyond surface appearances', url: '/reader/likutay-moharan/1/64' },
      { book: 'likutay-moharan', part: 1, torah: 4, title: 'Likutay Moharan 4', titleHe: 'ליקוטי מוהר"ן ד\'', desc: 'Holy knowledge (da\'at) — the highest form of wisdom that connects all understanding to its Source', url: '/reader/likutay-moharan/1/4' },
      { book: 'likutay-moharan', part: 2, torah: 12, title: 'Likutay Moharan II 12', titleHe: 'ליקוטי מוהר"ן תניינא י"ב', desc: 'The greatest wisdom is to not be wise at all — true humility before the infinite Creator', url: '/reader/likutay-moharan/2/12' },
      { book: 'likutay-moharan', part: 1, torah: 24, title: 'Likutay Moharan 24', titleHe: 'ליקוטי מוהר"ן כ"ד', desc: 'The unification of all wisdoms under Torah — every science reflects a facet of divine wisdom', url: '/reader/likutay-moharan/1/24' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 7, title: 'Likutay Moharan 7', titleHe: 'ליקוטי מוהר"ן ז\'', desc: 'Seeing Hashem\'s hand in everything — recognizing divine providence in daily life', url: '/reader/likutay-moharan/1/7' },
      { book: 'likutay-moharan', part: 2, torah: 5, title: 'Likutay Moharan II 5', titleHe: 'ליקוטי מוהר"ן תניינא ה\'', desc: 'Emunah reveals miracles — the stronger our faith, the more we see Hashem\'s wonders', url: '/reader/likutay-moharan/2/5' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Faith is the foundation of all miracles — through emunah, the impossible becomes possible', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-moharan', part: 1, torah: 2, title: 'Likutay Moharan 2', titleHe: 'ליקוטי מוהר"ן ב\'', desc: 'Prayer draws miracles — the weapon of Mashiach that can overturn all natural limitations', url: '/reader/likutay-moharan/1/2' },
      { book: 'likutay-moharan', part: 1, torah: 52, title: 'Likutay Moharan 52', titleHe: 'ליקוטי מוהר"ן נ"ב', desc: 'Gratitude and praise — how thanking Hashem for past miracles draws future ones', url: '/reader/likutay-moharan/1/52' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Peace is the vessel for all blessing — how to draw peace into the world through Torah', url: '/reader/likutay-moharan/1/14' },
      { book: 'likutay-moharan', part: 1, torah: 80, title: 'Likutay Moharan 80', titleHe: 'ליקוטי מוהר"ן פ\'', desc: 'Making peace between people — the great merit of those who pursue reconciliation', url: '/reader/likutay-moharan/1/80' },
      { book: 'likutay-moharan', part: 1, torah: 27, title: 'Likutay Moharan 27', titleHe: 'ליקוטי מוהר"ן כ"ז', desc: 'Ahavat Yisrael (love of fellow Jews) — the foundation upon which peace is built', url: '/reader/likutay-moharan/1/27' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'The ultimate peace will come through faith — emunah unifies all hearts', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-tefilos', part: 1, torah: 14, title: 'Likutay Tefilos 14', titleHe: 'ליקוטי תפילות י"ד', desc: 'R\' Nosson\'s prayer for universal peace', url: '/reader/likutay-tefilos/1/14' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 2, title: 'Likutay Moharan 2', titleHe: 'ליקוטי מוהר"ן ב\'', desc: 'The spiritual Temple built through prayer — each prayer is a stone in the eternal edifice', url: '/reader/likutay-moharan/1/2' },
      { book: 'likutay-moharan', part: 1, torah: 20, title: 'Likutay Moharan 20', titleHe: 'ליקוטי מוהר"ן כ\'', desc: 'Tikkun HaKlali — the general rectification that repairs all spiritual structures', url: '/reader/likutay-moharan/1/20' },
      { book: 'likutay-moharan', part: 1, torah: 61, title: 'Likutay Moharan 61', titleHe: 'ליקוטי מוהר"ן ס"א', desc: 'Building the world through truth — construction that endures must be founded on honesty', url: '/reader/likutay-moharan/1/61' },
      { book: 'likutay-moharan', part: 1, torah: 7, title: 'Likutay Moharan 7', titleHe: 'ליקוטי מוהר"ן ז\'', desc: 'Creating vessels for divine light — the spiritual architecture of the soul', url: '/reader/likutay-moharan/1/7' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 1, title: 'Likutay Moharan 1', titleHe: 'ליקוטי מוהר"ן א\'', desc: 'Torah is the source of all wisdom — learning Torah in order to teach is the highest form of study', url: '/reader/likutay-moharan/1/1' },
      { book: 'likutay-moharan', part: 1, torah: 282, title: 'Likutay Moharan 282', titleHe: 'ליקוטי מוהר"ן רפ"ב', desc: 'The simplicity of pure prayer — teaching children to speak to Hashem naturally', url: '/reader/likutay-moharan/1/282' },
      { book: 'likutay-moharan', part: 2, torah: 7, title: 'Likutay Moharan II 7', titleHe: 'ליקוטי מוהר"ן תניינא ז\'', desc: 'Da\'at (knowledge) as the root of all — educating the mind and heart together', url: '/reader/likutay-moharan/2/7' },
      { book: 'likutay-moharan', part: 2, torah: 24, title: 'Likutay Moharan II 24', titleHe: 'ליקוטי מוהר"ן תניינא כ"ד', desc: 'Joy in learning — creating an atmosphere of simcha that makes Torah learning come alive', url: '/reader/likutay-moharan/2/24' },
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 6, title: 'Likutay Moharan 6', titleHe: 'ליקוטי מוהר"ן ו\'', desc: 'Marriage and holiness — the deep connection between teshuvah and building a holy home', url: '/reader/likutay-moharan/1/6' },
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Shalom — peace in the home is the vessel for all blessings', url: '/reader/likutay-moharan/1/14' },
      { book: 'likutay-moharan', part: 1, torah: 56, title: 'Likutay Moharan 56', titleHe: 'ליקוטי מוהר"ן נ"ו', desc: 'Song and melody in the home — joy that sustains the marriage bond', url: '/reader/likutay-moharan/1/56' },
      { book: 'likutay-moharan', part: 2, torah: 8, title: 'Likutay Moharan II 8', titleHe: 'ליקוטי מוהר"ן תניינא ח\'', desc: 'The narrow bridge of relationships — overcoming challenges with faith and courage', url: '/reader/likutay-moharan/2/8' },
      { book: 'likutay-moharan', part: 1, torah: 23, title: 'Likutay Moharan 23', titleHe: 'ליקוטי מוהר"ן כ"ג', desc: 'Joy draws down spiritual abundance into the home', url: '/reader/likutay-moharan/1/23' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 13, title: 'Likutay Moharan 13', titleHe: 'ליקוטי מוהר"ן י"ג', desc: 'The immense power of tzedakah — charity opens all gates and sweetens all judgments', url: '/reader/likutay-moharan/1/13' },
      { book: 'likutay-moharan', part: 2, torah: 4, title: 'Likutay Moharan II 4', titleHe: 'ליקוטי מוהר"ן תניינא ד\'', desc: 'Hisbodedus (personal prayer) — even the poorest person can speak to Hashem', url: '/reader/likutay-moharan/2/4' },
      { book: 'likutay-moharan', part: 2, torah: 7, title: 'Likutay Moharan II 7', titleHe: 'ליקוטי מוהר"ן תניינא ז\'', desc: 'Livelihood flows from da\'at — knowledge of Hashem is the root of sustenance', url: '/reader/likutay-moharan/2/7' },
      { book: 'likutay-moharan', part: 2, torah: 3, title: 'Likutay Moharan II 3', titleHe: 'ליקוטי מוהר"ן תניינא ג\'', desc: 'Finding good points even in the depths of poverty and hardship', url: '/reader/likutay-moharan/2/3' },
      { book: 'likutay-moharan', part: 2, torah: 24, title: 'Likutay Moharan II 24', titleHe: 'ליקוטי מוהר"ן תניינא כ"ד', desc: 'Simcha (joy) even in poverty — joy itself is a form of wealth', url: '/reader/likutay-moharan/2/24' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 1, title: 'Likutay Moharan 1', titleHe: 'ליקוטי מוהר"ן א\'', desc: 'Finding divine wisdom in all things — even in human creations, there is a spark of the Creator', url: '/reader/likutay-moharan/1/1' },
      { book: 'likutay-moharan', part: 1, torah: 54, title: 'Likutay Moharan 54', titleHe: 'ליקוטי מוהר"ן נ"ד', desc: 'The power of speech and language — understanding how words shape reality', url: '/reader/likutay-moharan/1/54' },
      { book: 'likutay-moharan', part: 1, torah: 64, title: 'Likutay Moharan 64', titleHe: 'ליקוטי מוהר"ן ס"ד', desc: 'The test of knowledge — when wisdom grows, so does the potential for both good and harm', url: '/reader/likutay-moharan/1/64' },
      { book: 'likutay-moharan', part: 2, torah: 5, title: 'Likutay Moharan II 5', titleHe: 'ליקוטי מוהר"ן תניינא ה\'', desc: 'Faith above intellect — emunah must guide how we use knowledge and technology', url: '/reader/likutay-moharan/2/5' },
      { book: 'likutay-moharan', part: 2, torah: 12, title: 'Likutay Moharan II 12', titleHe: 'ליקוטי מוהר"ן תניינא י"ב', desc: 'Not being wise in one\'s own eyes — humility in the face of human achievement', url: '/reader/likutay-moharan/2/12' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 56, title: 'Likutay Moharan 56', titleHe: 'ליקוטי מוהר"ן נ"ו', desc: 'Every blade of grass sings a song — the melody of creation and the sanctity of nature', url: '/reader/likutay-moharan/1/56' },
      { book: 'likutay-moharan', part: 2, torah: 11, title: 'Likutay Moharan II 11', titleHe: 'ליקוטי מוהר"ן תניינא י"א', desc: 'Hisbodedus in nature — going out to the fields and forests to connect with Hashem through creation', url: '/reader/likutay-moharan/2/11' },
      { book: 'likutay-moharan', part: 1, torah: 1, title: 'Likutay Moharan 1', titleHe: 'ליקוטי מוהר"ן א\'', desc: 'Finding the divine intellect in all of creation — seeing Hashem through nature', url: '/reader/likutay-moharan/1/1' },
      { book: 'likutay-moharan', part: 1, torah: 52, title: 'Likutay Moharan 52', titleHe: 'ליקוטי מוהר"ן נ"ב', desc: 'Gratitude for creation — praising Hashem for the world He made', url: '/reader/likutay-moharan/1/52' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Emunah — strengthening faith when persecution arises; faith is the light that darkness cannot overcome', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-moharan', part: 1, torah: 64, title: 'Likutay Moharan 64', titleHe: 'ליקוטי מוהר"ן ס"ד', desc: 'Coming to Pharaoh — confronting the source of evil and finding Hashem even there', url: '/reader/likutay-moharan/1/64' },
      { book: 'likutay-moharan', part: 2, torah: 8, title: 'Likutay Moharan II 8', titleHe: 'ליקוטי מוהר"ן תניינא ח\'', desc: 'The world is a narrow bridge — not to be afraid even when surrounded by enemies', url: '/reader/likutay-moharan/2/8' },
      { book: 'likutay-moharan', part: 1, torah: 33, title: 'Likutay Moharan 33', titleHe: 'ליקוטי מוהר"ן ל"ג', desc: 'Am Yisrael and the Torah — the eternal bond between the Jewish people and their mission', url: '/reader/likutay-moharan/1/33' },
      { book: 'likutay-moharan', part: 1, torah: 5, title: 'Likutay Moharan 5', titleHe: 'ליקוטי מוהר"ן ה\'', desc: 'Joy in the face of adversity — transforming fear and suffering into spiritual elevation', url: '/reader/likutay-moharan/1/5' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 34, title: 'Likutay Moharan 34', titleHe: 'ליקוטי מוהר"ן ל"ד', desc: 'The power of gathering — when Jews come together, the Shechinah rests among them', url: '/reader/likutay-moharan/1/34' },
      { book: 'likutay-moharan', part: 1, torah: 27, title: 'Likutay Moharan 27', titleHe: 'ליקוטי מוהר"ן כ"ז', desc: 'Love of fellow Jews — the foundation of true community and the vessel for divine light', url: '/reader/likutay-moharan/1/27' },
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Peace and unity — drawing peace into the world through communal Torah and prayer', url: '/reader/likutay-moharan/1/14' },
      { book: 'likutay-moharan', part: 1, torah: 56, title: 'Likutay Moharan 56', titleHe: 'ליקוטי מוהר"ן נ"ו', desc: 'The song of the future — a melody that unites all voices into one harmonious song', url: '/reader/likutay-moharan/1/56' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Emunah unites all hearts — faith is the common ground of all souls', url: '/reader/likutay-moharan/2/1' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 1, title: 'Likutay Moharan 1', titleHe: 'ליקוטי מוהר"ן א\'', desc: 'Contemplating the divine intellect in all of creation — from the smallest atom to the greatest galaxy', url: '/reader/likutay-moharan/1/1' },
      { book: 'likutay-moharan', part: 1, torah: 5, title: 'Likutay Moharan 5', titleHe: 'ליקוטי מוהר"ן ה\'', desc: 'The fear of Hashem through contemplating His greatness — awe before the infinite Creator', url: '/reader/likutay-moharan/1/5' },
      { book: 'likutay-moharan', part: 2, torah: 12, title: 'Likutay Moharan II 12', titleHe: 'ליקוטי מוהר"ן תניינא י"ב', desc: 'The greatest wisdom is to know that we know nothing — humility before the vastness of creation', url: '/reader/likutay-moharan/2/12' },
      { book: 'likutay-moharan', part: 1, torah: 56, title: 'Likutay Moharan 56', titleHe: 'ליקוטי מוהר"ן נ"ו', desc: 'The song of creation — every element of the cosmos sings its unique melody', url: '/reader/likutay-moharan/1/56' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 10, title: 'Likutay Moharan 10', titleHe: 'ליקוטי מוהר"ן י\'', desc: 'True judgment — the Tzaddik who judges with wisdom, humility, and mercy', url: '/reader/likutay-moharan/1/10' },
      { book: 'likutay-moharan', part: 1, torah: 5, title: 'Likutay Moharan 5', titleHe: 'ליקוטי מוהר"ן ה\'', desc: 'Transforming strict judgment (din) into mercy — sweetening decrees through joy and prayer', url: '/reader/likutay-moharan/1/5' },
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Raising honor to its root (fear of God) — true justice requires fear of Heaven', url: '/reader/likutay-moharan/1/14' },
      { book: 'likutay-moharan', part: 2, torah: 3, title: 'Likutay Moharan II 3', titleHe: 'ליקוטי מוהר"ן תניינא ג\'', desc: 'Judging others favorably — finding the good point even in those who seem guilty', url: '/reader/likutay-moharan/2/3' },
      { book: 'likutay-moharan', part: 1, torah: 51, title: 'Likutay Moharan 51', titleHe: 'ליקוטי מוהר"ן נ"א', desc: 'Truth and justice — the inseparable connection between honesty and righteous judgment', url: '/reader/likutay-moharan/1/51' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 64, title: 'Likutay Moharan 64', titleHe: 'ליקוטי מוהר"ן ס"ד', desc: 'The deepest exile — finding Hashem even in the most foreign and dark places', url: '/reader/likutay-moharan/1/64' },
      { book: 'likutay-moharan', part: 2, torah: 8, title: 'Likutay Moharan II 8', titleHe: 'ליקוטי מוהר"ן תניינא ח\'', desc: 'The narrow bridge — not being afraid during uncertain journeys and transitions', url: '/reader/likutay-moharan/2/8' },
      { book: 'likutay-moharan', part: 1, torah: 21, title: 'Likutay Moharan 21', titleHe: 'ליקוטי מוהר"ן כ"א', desc: 'The Land of Israel — the longing for home and the spiritual power of Eretz Yisrael', url: '/reader/likutay-moharan/1/21' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Faith during transition — emunah sustains through all displacement and upheaval', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-moharan', part: 1, torah: 13, title: 'Likutay Moharan 13', titleHe: 'ליקוטי מוהר"ן י"ג', desc: 'Charity for the displaced — the merit of helping those in need', url: '/reader/likutay-moharan/1/13' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 277, title: 'Likutay Moharan 277', titleHe: 'ליקוטי מוהר"ן רע"ז', desc: 'Medicine and healing — the spiritual roots behind physical remedies and treatments', url: '/reader/likutay-moharan/1/277' },
      { book: 'likutay-moharan', part: 2, torah: 24, title: 'Likutay Moharan II 24', titleHe: 'ליקוטי מוהר"ן תניינא כ"ד', desc: 'Joy is the greatest medicine — simcha heals body and soul', url: '/reader/likutay-moharan/2/24' },
      { book: 'likutay-moharan', part: 1, torah: 31, title: 'Likutay Moharan 31', titleHe: 'ליקוטי מוהר"ן ל"א', desc: 'The ten kinds of melody — music and song as instruments of healing', url: '/reader/likutay-moharan/1/31' },
      { book: 'likutay-moharan', part: 2, torah: 3, title: 'Likutay Moharan II 3', titleHe: 'ליקוטי מוהר"ן תניינא ג\'', desc: 'Finding the good points — hope and positivity as pathways to recovery', url: '/reader/likutay-moharan/2/3' },
      { book: 'likutay-moharan', part: 1, torah: 14, title: 'Likutay Moharan 14', titleHe: 'ליקוטי מוהר"ן י"ד', desc: 'Peace and wholeness — shalom is the root of all healing', url: '/reader/likutay-moharan/1/14' },
    ],
    traditionalSources: [
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 6, title: 'Likutay Moharan 6', titleHe: 'ליקוטי מוהר"ן ו\'', desc: 'Teshuvah — the great teaching on repentance and its power to rectify everything', url: '/reader/likutay-moharan/1/6' },
      { book: 'likutay-moharan', part: 2, torah: 12, title: 'Likutay Moharan II 12', titleHe: 'ליקוטי מוהר"ן תניינא י"ב', desc: 'There is no despair at all — the foundational principle that return is always possible', url: '/reader/likutay-moharan/2/12' },
      { book: 'likutay-moharan', part: 2, torah: 3, title: 'Likutay Moharan II 3', titleHe: 'ליקוטי מוהר"ן תניינא ג\'', desc: 'Azamra — finding the good points; even a little good is the beginning of teshuvah', url: '/reader/likutay-moharan/2/3' },
      { book: 'likutay-moharan', part: 2, torah: 1, title: 'Likutay Moharan II 1', titleHe: 'ליקוטי מוהר"ן תניינא א\'', desc: 'Emunah — faith that teshuvah is always accepted and always transformative', url: '/reader/likutay-moharan/2/1' },
      { book: 'likutay-moharan', part: 2, torah: 4, title: 'Likutay Moharan II 4', titleHe: 'ליקוטי מוהר"ן תניינא ד\'', desc: 'Hisbodedus — personal prayer as the gateway to teshuvah and genuine connection', url: '/reader/likutay-moharan/2/4' },
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 2, torah: 7, title: 'Likutay Moharan II 7', titleHe: 'ליקוטי מוהר"ן תניינא ז\'', desc: 'Livelihood and knowledge — true prosperity flows from connection to Hashem', url: '/reader/likutay-moharan/2/7' },
      { book: 'likutay-moharan', part: 1, torah: 69, title: 'Likutay Moharan 69', titleHe: 'ליקוטי מוהר"ן ס"ט', desc: 'The test of wealth — overcoming the desire for money that pulls one away from holiness', url: '/reader/likutay-moharan/1/69' },
      { book: 'likutay-moharan', part: 1, torah: 13, title: 'Likutay Moharan 13', titleHe: 'ליקוטי מוהר"ן י"ג', desc: 'Tzedakah — using wealth for charity is the key to sustained blessing', url: '/reader/likutay-moharan/1/13' },
      { book: 'likutay-moharan', part: 1, torah: 23, title: 'Likutay Moharan 23', titleHe: 'ליקוטי מוהר"ן כ"ג', desc: 'Joy and abundance — holy joy draws down spiritual and physical prosperity', url: '/reader/likutay-moharan/1/23' },
  ...
  },
  {
    ...
    breslovSources: [
      { book: 'likutay-moharan', part: 1, torah: 8, title: 'Likutay Moharan 8', titleHe: 'ליקוטי מוהר"ן ח\'', desc: 'The storm and the Ark — finding shelter in holy words when the world is turbulent', url: '/reader/likutay-moharan/1/8' },
      { book: 'likutay-moharan', part: 1, torah: 56, title: 'Likutay Moharan 56', titleHe: 'ליקוטי מוהר"ן נ"ו', desc: 'The melodies of nature — wind and storms have their own divine song', url: '/reader/likutay-moharan/1/56' },
      { book: 'likutay-moharan', part: 2, torah: 5, title: 'Likutay Moharan II 5', titleHe: 'ליקוטי מוהר"ן תניינא ה\'', desc: 'Emunah in the storm — maintaining faith when the world feels chaotic and frightening', url: '/reader/likutay-moharan/2/5' },
      { book: 'likutay-moharan', part: 2, torah: 8, title: 'Likutay Moharan II 8', titleHe: 'ליקוטי מוהר"ן תניינא ח\'', desc: 'The narrow bridge — courage in the face of overwhelming natural forces', url: '/reader/likutay-moharan/2/8' },
      { book: 'likutay-moharan', part: 1, torah: 5, title: 'Likutay Moharan 5', titleHe: 'ליקוטי מוהר"ן ה\'', desc: 'Sweetening harsh judgments — how joy and prayer can calm the storms of judgment', url: '/reader/likutay-moharan/1/5' },
    ],
    traditionalSources: [
...
function resolveUrl(source) {
  ...
  if (parts.length === 2) {
    ...
    // e.g., /reader/likutay-moharan/1/14
