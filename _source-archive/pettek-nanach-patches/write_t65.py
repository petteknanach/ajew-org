...
out_path = os.path.join(pnc_dir, 'torah-65.json')
...
"Frame verse: Ruth 2:8-9. Teaching: the 'field' = spiritual field of holy souls. 'Baal hasadeh' (Boaz/master of the field) = tzaddik overseeing the souls. Topic arc: sadeh → neshamot → tachlis (echad) → bittul → ratzo v'shov → yissurin → chiddushei Torah → tefillah as echad → MaNTzPaCh.",
"פָּסוּק מַנְחֶה: רוּת ב:ח-ט. כּוֹתֶרֶת: \"שְׂדֵה הַנְּשָׁמוֹת.\" קֶשֶׁר: הַשָּׂדֶה = שְׂדֵה נְשָׁמוֹת קְדוֹשׁוֹת. בַּעַל הַשָּׂדֶה (בֹּעַז/הַצַּדִּיק) = מְפַקֵּחַ. נושֵׂא: שָׂדֶה → נְשָׁמוֹת → תַּכְלִית (אֶחָד) → בִּטּוּל → יִסּוּרִים → חִדּוּשֵׁי תּוֹרָה → תְּפִלָּה כְּאֶחָד.",
"רוּת ב:ח-ט."
),
seg(2,
...
"There is a sadeh (field) of beautiful trees/grasses = neshamot kedoshot. Also: neshamot arumos (naked/unclothed souls) wander outside the sadeh, waiting for their tikkun. Baal hasadeh tends both. Field = realm of fulfilled neshamot; outside = realm of incomplete/fallen neshamot.",
"יֵשׁ שָׂדֶה שֶׁל עֵצִים וּדְשָׁאִים יְפֵה מְאד = נְשָׁמוֹת קְדוֹשׁוֹת. גַּם: נְשָׁמוֹת עֲרוּמוֹת מְטַיְּלוֹת מִחוּץ לַשָּׂדֶה, מְחַכּוֹת לְתִיקּוּנָן. בַּעַל הַשָּׂדֶה = מְטַפֵּל בִּשְׁנֵי הַסּוּגִים.",
"רוּת ב:ח-ט."
),
seg(3,
...
"Neshamot produce peirot (fulfill God's will) → eyes of baal hasadeh shine → 'Sadeh Tzofim' (Bamidbar 23:14) = field of spiritual sight/watchers. Neshamot don't produce → eyes darkened (Ohalos). Baal hasadeh's vision = conditional on the field's spiritual fruitfulness.",
"נְשָׁמוֹת מְפָרוֹת → עֵינֵי בַּעַל הַשָּׂדֶה מֵאִירוֹת → \"שְׂדֵה צוֹפִים\" (בַּמִּד' כג:יד). נְשָׁמוֹת אֵינָן מְפָרוֹת → עֵינָיו מִתְכַּהוֹת (אָהֳלוֹת).",
...
"'Echad' = tachlis. Zech 14:9 'b'yom hahu yihyeh Hashem echad u'shmo echad.' Pesachim 50a: is He not one now? Now: 'dayan ha-emet' for bad / 'hatov v'hameitiv' for good = we perceive separateness. At tachlis: only good = only echad. Tachlis = pure unity, evil has no separate existence.",
"\"אֶחָד\" = תַּכְלִית. זְכַרְיָה יד:ט \"בַּיּוֹם הַהוּא יִהְיֶה ה' אֶחָד וּשְׁמוֹ אֶחָד.\" פְּסָחִים נ: הֲלֹא עַתָּה אֶחָד? עַתָּה: \"דַּיַּן הָאֱמֶת\" עַל הָרַע / \"הַטּוֹב וְהַמֵּטִיב\" עַל הַטּוֹב. לֶעָתִיד: הַכֹּל טוֹב = אֶחָד.",
...
"At bittul to tachlis (entirely echad/good) → yissurin nullified. But cannot stay permanently in bittul — would exit human condition. Therefore: bittul must be ratzo v'shov (Yechezkel's chariot oscillation). When sechel drawn toward tachlis (ratzo) → yissurin nullified; when returns to vessels (shov) → yissurin return.",
"בִּשְׁעַת בִּטּוּל לְהַתַּכְלִית (אֶחָד וְטוֹב כֻּלּוֹ) → יִסּוּרִים מִתְבַּטְּלִים. אֲבָל: בִּטּוּל קָבוּעַ בִּלְתִּי אֶפְשָׁרִי — יֵצֵא מִגֶּדֶר אֱנוֹשִׁי. לָכֵן: בִּטּוּל בִּבְחִינַת רָצוֹא וָשׁוֹב (יְחֶז' א:יד).",
...
"Returning from bittul to vessels: yissurin intensify. Analogy: two wrestlers — when one sees he's being overpowered, he fights harder. Similarly: baalei dinim see person aspiring to rise via bittul → redouble pressure. Intensification of yissurin = sign of spiritual effort; do not be discouraged.",
"חֲזָרָה מִבִּטּוּל לַכֵּלִים: יִסּוּרִים מִתְגַּבְּרִים. מָשָׁל: שְׁנֵי מִתְאַבְּקִים. כֵּן: בַּעֲלֵי דִינִים רוֹאִים עֲלִיָּה בַּבִּטּוּל → מַגְבִּירִים לַחַץ. הִתְגַּבְּרוּת יִסּוּרִים = סִמַּן מַאֲמָץ רוּחָנִי.",
"יְחֶז' א:יד."
),
seg(7,
...
"Yissurin cooled via chiddushei Torah. Yesh 55:1 'ho kol tzameh lechu la-mayim' = Torah-waters satisfy the spiritual thirst. Teh 94:12 'ashrei ha'gever asher y'yassrenu Kah u'm'Toratecha t'lamdennu' = through yissurin one merits Torah innovations. Sign of proper receipt of yissurin = subsequent chiddushei Torah.",
"יִסּוּרִים מִתְקָרְרִים עַל יְדֵי חִדּוּשֵׁי תוֹרָה. יְשַׁ' נה:א \"הוֹי כָּל צָמֵא לְכוּ לַמָּיִם\". תְּהִ' צד:יב \"אַשְׁרֵי הַגֶּבֶר אֲשֶׁר תְּיַסְּרֶנּוּ יָהּ וּמִתּוֹרָתְך תְּלַמְּדֶנּוּ\". סִמַּן קַבָּלַת יִסּוּרִים כָּרָאוּי = חִדּוּשֵׁי תוֹרָה לְאַחַר מִכֵּן.",
...
"Baal hasadeh (when eyes shine = Sadeh Tzofim) can gauge each person's proximity to tachlis. Sign of far from tachlis = tefillah not unified: cannot make 'echad' from the whole tefillah; forgets beginning of word when reaching end. Goal of tefillah = echad = hold entire word/prayer in unified consciousness simultaneously.",
"בַּעַל הַשָּׂדֶה (עֵינַיִם מְאִירוֹת = שְׂדֵה צוֹפִים) רוֹאֶה כָּל נֶפֶשׁ וּמֶרְחָקָהּ מֵהַתַּכְלִית. סִמַּן רִיחוּק = תְּפִלָּה לֹא מְאוּחֶדֶת: שׁוֹכֵחַ רֵאשִׁית הַמִּלָּה בְּסוֹפָהּ. מַטָּרַת הַתְּפִלָּה = אֶחָד = לְהַחֲזִיק אֶת כָּל הַמִּלָּה/הַתְּפִלָּה בְּמוּדָעוּת אַחַת.",
...
"Baal hasadeh brings soul to tachlis = echad → tefillah unified, beginning and end held simultaneously. Shabbat 104a: 'MaNTzPaCh tzofim tiknum' (five final-letter forms established by the watchers). MaNTzPaCh = heh at beginning of word + heh at end = baal hasadeh = tzofeh holds beginning and end. Unified tefillah = echad.",
"בַּעַל הַשָּׂדֶה מְבִיא לְתַכְלִית = אֶחָד → תְּפִלָּה מְאוּחֶדֶת, רֵאשִׁית וְסוֹף מוּחְזָקִים בְּעֵת וָאֶחַת. שַׁבָּת קד: \"מנצפ\"ך צוֹפִים תִּקְּנוּם\" — ה' בְּרֵאשִׁית וְה' בְּסוֹף = בַּעַל הַשָּׂדֶה = צוֹפֶה = מְאַחֵד רֵאשִׁית וְסוֹף הַתְּפִלָּה = אֶחָד.",
...
"Discourse unfinished ('v'lo ger zeh ha'torah'). Complete arc given: sadeh → baal hasadeh → tachlis (echad) → bittul → ratzo v'shov → yissurin → chiddushei Torah → tefillah as echad → MaNTzPaCh/tzofim. The final image: tzaddik-watcher holding beginning and end in one vision.",
"הַתּוֹרָה לֹא הֻשְׁלְמָה (\"וְלֹא גָּמַר זאֹת הַתּוֹרָה\"). הִתְפַּתְּחוּת שְׁלֵמָה: שָׂדֶה → בַּעַל הַשָּׂדֶה → תַּכְלִית (אֶחָד) → בִּטּוּל → רָצוֹא וָשׁוֹב → יִסּוּרִים → חִדּוּשֵׁי תּוֹרָה → תְּפִלָּה כְּאֶחָד → מנצפ\"ך/צוֹפִים.",
...
data = {
    ...
    "part": 1,
    "torah": 65,
    "title": "T65 Petten Nanach Commentary - Vayomer Boaz L'Rut (Field of Souls, Tachlis, Bittul, Prayer Unity, 10 segs)",
    "hebrewTitle": "ויאמר בועז לרות — שדה הנשמות, תכלית, ביטול, ותפילה כאחד",
...
with open(lm_path, encoding='utf-8') as f:
    cdata = json.load(f)
cdata['1']['65']['running_commentary'] = {
    "book": pnc_name,
    "slug": pnc_name,
    "status": "available",
    "url": f"/reader/{pnc_name}/torah-65.json",
    "layers": ["beginner", "intermediate", "scholarly"],
    "author": "Petten Nanach",
    "label": "Petten Nanach Running Commentary - T65 (Sadeh Neshamot / Field of Souls, Tachlis, Bittul, 10 segs)"
}
with open(lm_path, 'w', encoding='utf-8') as f:
    json.dump(cdata, f, ensure_ascii=False, indent=2)
print("lm-commentaries.json updated for T65")

t65_git = 'public/reader/' + pnc_name + '/torah-65.json'
subprocess.run(['git', 'add', 'src/data/lm-commentaries.json', t65_git], cwd=repo, check=True)
r2 = subprocess.run(['git', 'commit', '-m', 'feat: T65 PNC -- Vayomer Boaz L\'Rut (sadeh neshamot/tachlis/bittul/tefillah echad, 10 segs)'], cwd=repo, capture_output=True, text=True)
