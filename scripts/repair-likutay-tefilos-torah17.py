...
def main():
 ...
 data={'id':'lt-1-17','book':'likutay-tefilos','part':1,'torah':17,'displayNumber':17,'title':'Prayer Seventeen','hebrewTitle':'תפילה יז','segments':segments,'aligned_segments':segments,'totalParagraphs':14,'totalSegments':14,'hasEnglish':True,'navigation':{'prev':'lt-2-2-16','next':'lt-2-2-18','prevUrl':'/reader/likutay-tefilos/1/16','nextUrl':'/reader/likutay-tefilos/1/18'},'superReaderRepairSource':str(HTML.relative_to(ROOT)),'excludedMetadata':{'dateBars':5,'reason':'Date dividers are metadata, not prayer records'},'dateGroups':{'4 Cheshvan':['p17a','p17g'],'5 Cheshvan':['p17h','p17i'],'6 Cheshvan':['p17j','p17l'],'7 Cheshvan':['p17m','p17m'],'8 Cheshvan':['p17n','p17n']}}
