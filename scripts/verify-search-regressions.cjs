...
if (lightHalachos.length !== expectedCanonicalHalachos || lightHalachosPaths.size !== expectedCanonicalHalachos) {
  fail(`canonical Hebrew index has ${lightHalachos.length} Likutay Halachos docs / ${lightHalachosPaths.size} unique paths; expected ${expectedCanonicalHalachos}/${expectedCanonicalHalachos}`);
}
...
if (!completeReaderArtifacts) {
  ...
  if (halachosItems.length !== expectedCanonicalHalachos || halachosPaths.size !== expectedCanonicalHalachos) {
    fail(`reader-search metadata has ${halachosItems.length} Likutay Halachos docs / ${halachosPaths.size} unique paths; expected ${expectedCanonicalHalachos}/${expectedCanonicalHalachos}`);
  }
