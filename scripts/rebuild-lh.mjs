...
for (const vol of volumes) {
    ...
    indexHtml += \\n    <div class="volume-section" id="\">\n      <h2 class="volume-title">\</h2>\n      <div class="topics-grid">\n\;

    const files = fs.readdirSync(volPath).filter(f => f.endsWith('.html'));

    // Sort files numerically by the prefix
    files.sort((a, b) => {
    ...
    for (const file of files) {
        // Strip leading number and clean up filename for title
        ...
        const astroContent = \---
import Layout from '../../../../layouts/Layout.astro';
const pageTitle = "Likutay Halachos - \";
const pageDescription = "Breslov teachings from Likutay Halachos: \";
---
<Layout title={pageTitle} description={pageDescription}>
  ...
  <div class="lh-container">
    \
        ...
        fs.writeFileSync(path.join(volDest, \\.astro\), astroContent, 'utf8');

        indexHtml += \        <a href="/teachings/likutay-halachos/\/\" class="topic-card">\n          <div class="topic-card-body">\</div>\n        </a>\n\;
    }
