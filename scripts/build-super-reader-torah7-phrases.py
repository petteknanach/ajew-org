#!/usr/bin/env python3
"""Build Torah 7's phrase navigation from aligned text and synchronized commentary."""
...
SELECTED = [1, 3, 5, 6, 8, 10, 12, 13, 15, 17, 19, 20, 22, 24, 26, 27, 29, 31, 33, 34, 36, 38, 40, 41, 43, 45, 47, 50, 53, 54]
...
def main() -> None:
    ...
    for position, index in enumerate(SELECTED, start=1):
        ...
        explanation = f'“{direct_line}” — {commentary_text or f"This line develops section {classic} of Torah 7."}'
        phrases.append({
    ...
    payload = {
        'title': 'Torah 7 phrase-by-phrase study guide',
    ...
    print(f'Prepared {len(phrases)} Torah 7 phrase-study entries.')
