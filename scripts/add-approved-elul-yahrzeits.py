...
APPROVED = [
    ...
    entry('Rabbi Yaakov of Orléans', 'רבי יעקב מאורליינש', 19, '1189',
          'Distinguished Baal Tosafos and disciple of Rabbeinu Tam; martyred in London during the anti-Jewish riots at the coronation of Richard I.', 'rishonim',
          'User-approved: https://x.com/Yahrtzeits/status/2094539668947665082'),
