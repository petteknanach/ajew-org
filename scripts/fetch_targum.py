#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Targum texts (Onkelos / Jonathan / Yerushalmi) from Sefaria's public
API at build time and store per-book JSON for the Tikkun Korim shnayim-mikra
mode. Output: public/reader/medooyuk/targum/<slug>.json
  {"name": "<sefaria index name>", "ch": {"1": {"1": "verse text"}}}
Books where Sefaria serves no text get no file (the UI hides the option).
"""
