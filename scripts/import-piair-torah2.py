#!/usr/bin/env python3
"""Prepare a section-aware Pe'er HaLikutim Torah 2 dataset for the Super Reader.
...
OUT = ROOT / 'public' / 'reader' / 'super' / 'likutay-moharan' / '1' / '2' / 'peer-halikutim'
FIRST_PAGE = 65
LAST_PAGE = 87
...
PAGE_SECTIONS = {
    ...
    74: [5], 75: [5],
    76: [6], 77: [6],
    **{page: [7] for page in range(78, 88)},
}
...
PAGE_PASSAGES = {
    ...
    68: [5, 6], 69: [5, 6],
    70: [7, 8, 9], 71: [7, 8, 9],
    72: [10, 11, 12, 13, 14], 73: [10, 11, 12, 13, 14],
    74: [15, 16, 17], 75: [15, 16, 17],
    76: [18, 19], 77: [18, 19],
    78: [20, 21, 22, 23], 79: [20, 21, 22, 23],
    80: [24, 25],
    81: [26, 27],
    82: [28, 29, 30],
    83: [31, 32, 33],
...
def main() -> None:
    ...
    excerpt_path = OUT / 'peer-halikutim-torah-2.pdf'
    ...
    for source_page in range(FIRST_PAGE, LAST_PAGE + 1):
        ...
        pages.append({
            ...
            'printedFolio': None,
            'image': f'/reader/super/likutay-moharan/1/2/peer-halikutim/{filename}',
    ...
    manifest = {
        'schemaVersion': 2,
        'title': "Pe’er HaLikutim — Torah 2",
        'hebrewTitle': 'פאר הליקוטים — תורה ב',
        'sourceFile': SOURCE.name,
        'sourcePageRange': [FIRST_PAGE, LAST_PAGE],
        'pdf': '/reader/super/likutay-moharan/1/2/peer-halikutim/peer-halikutim-torah-2.pdf',
