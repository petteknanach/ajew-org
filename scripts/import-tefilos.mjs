...
const destDir = path.join(rootDir, 'src', 'pages', 'teachings', 'likutay-tefilos');
...
'  ' + '\n' +
'  .tefilos-container {' + '\n' +
'    --ink:#1c1c2e;--parchment:#f7f3ea;--parchment2:#eee8d5;--gold:#a07830;--gold-light:#c8a050;--sapphire:#1e3a5f;--sapphire2:#2e5580;--sapphire-pale:#dde8f5;--ruby:#7a1a2e;--border:#b89860;--muted:#5a5040;--verse-color:#1e3a5f;--source-color:#888070;' + '\n' +
'    font-family:\'EB Garamond\',Georgia,serif;' + '\n' +
'    font-size:18px;line-height:2;color:var(--ink);' + '\n' +
'    background:var(--parchment);padding-bottom:80px;' + '\n' +
'  }' + '\n' +
...
for (const file of filesToProcess) {
    ...
    let slug = file.replace(/\.html$/, '').replace(/\s+\(1\)$/, '').toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, '');
