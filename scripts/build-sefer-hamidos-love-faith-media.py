...
BATCH = [
    # Next 40 teachings after Truth 1-60 and Hospitality 1-10.
    {'topic': 3, 'slug': 'love', 'title': 'Love / אַהֲבָה', 'segments': list(range(1, 19))},
    {'topic': 4, 'slug': 'faith', 'title': 'Faith / אֱמוּנָה', 'segments': list(range(1, 23))},
]
