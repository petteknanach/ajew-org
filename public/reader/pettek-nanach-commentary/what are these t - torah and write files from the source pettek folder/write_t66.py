...
out_path = os.path.join(pnc_dir, 'torah-66.json')
...
"Frame verse: Melachim II 2:9-10 (Elisha asks Elijah for 'pi shnayim b'ruchacha'). Subtitle: 'ha'avaras ha'ruach.' Teaching arc: spirit transmission at histalkut → hakchalat penei rabbo → non-dependence → completeness of speech/nekudot → preventions at true tzaddik → prayer b'emet.",
"פָּסוּק מַנְחֶה: מל\"ב ב:ט-י. כּוֹתֶרֶת: \"הֲעָרַת הָרוּחַ.\" קֶשֶׁר: מַסָּרַת רוּחַ בְּהִסְתַּלְּקוּת → הַקְבָּלַת פְּנֵי הָרַב → אֵי-תְּלוּת בִּבְרִיּוֹת → שְׁלֵמוּת הַדִּבּוּר/נְקוּדוֹת → מְנִיעוֹת בְּגֶשֶׁת לַצַּדִּיק הָאֱמִתִּי → תְּפִלָּה בֶּאֱמֶת.",
"מֶ\"ב ב:ט-י."
),
seg(2,
"Opening: the verse from II Kings 2:9-10 where Elisha asks for double of Elijah's spirit, and Elijah's conditional promise.",
"Verses: Melachim II 2:9-10.",
"פְּסוּקִים: מֶ\"ב ב:ט-י.",
"מֶ\"ב ב:ט-י."
),
seg(3,
...
"Elisha received double (Melachim II 2). All Elisha's miracles = through prayer (Megillah 27a). Principle: student can pray with greater kavanah and do more than teacher — all through 'pi shnayim' (double spirit) mechanism.",
"אֱלִישָׁע קִיבֵּל פִּי שְׁנַיִם — כָּל נִסָּיו עַל יְדֵי תְּפִלָּה (מְגִלָּה כז:). עִיקָּרוֹן: תַּלְמִיד יָכוֹל לְהִתְפַּלֵּל בְּיוֹתֵר כַּוָּנָה וְלַעֲשׂוֹת יוֹתֵר מֵרַבּוֹ — כֻּלּוֹ עַל יְדֵי \"פִּי שְׁנַיִם\" = מְנַגְנוּן הַהֲעָרָה.",
"מֶ\"ב ב; מְגִלָּה כז:."
),
seg(4,
...
"At histalkut (passing) of tzaddik: attains far more than in lifetime. Examples: R' Shimon bar Yochai b'Idra (Zohar) — revealed deepest secrets at his passing; also Rebbe Nachman himself. Each tzaddik at histalkut reaches proportionally higher than their lifetime achievements.",
"בְּהִסְתַּלְּקוּת הַצַּדִּיק: מַשִּׂיג הַרְבֵּה יוֹתֵר מֵחַיָּיו. דֻּגְמָאוֹת: רַשְׁבִּ\"י בְּאִדְרָא (זֹהַר); רַבֵּנוּ הַקָּדוֹשׁ. כָּל צַדִּיק לְפִי דַּרְגָּתוֹ.",
...
"Mechanism of double spirit at histalkut: higher ruach descends → meets lower ruach → both are truly one → intense union → higher ruach ascends (cannot remain in olam) → carries tzaddik with it = histalkut. Student present at that moment receives double illumination. 'Im tir'eni lukach me'itach yiyeh lach' — seeing = receiving the double.",
"מְנַגְנוּן \"פִּי שְׁנַיִם\" בְּהִסְתַּלְּקוּת: רוּחַ הָעֶלְיוֹן יוֹרֶדֶת → פּוֹגֶשֶׁת רוּחַ הַתַּחְתּוֹן → שְׁנֵיהֶם אֶחָד → אִחוּד עָצוּם → רוּחַ הָעֶלְיוֹן עוֹלָה → מַעֲלָה הַצַּדִּיק עִמָּהּ = הִסְתַּלְּקוּת. תַּלְמִיד נוֹכֵחַ מְקַבֵּל \"פִּי שְׁנַיִם\".",
...
"Hakchalat penei rabbo = always strive to be present with teacher. Reason: perhaps now is the moment of histalkut → being present = receiving double illumination. One who receives double can pray with greater kavanah and do more than the teacher — all via pi shnayim.",
"הַקְבָּלַת פְּנֵי הָרַב: לְהִשְׁתַּדֵּל תָּמִיד לִהְיוֹת נוֹכֵחַ אֵצֶל הָרַב. טַעַם: אוּלַי עַכְשָׁו שְׁעַת הִסְתַּלְּקוּת → נוֹכֵחוּת = קַבָּלַת \"פִּי שְׁנַיִם\". הַמְּקַבֵּל \"פִּי שְׁנַיִם\" — יָכוֹל לְהִתְפַּלֵּל בְּיוֹתֵר כַּוָּנָה וְלַעֲשׂוֹת יוֹתֵר מֵרַבּוֹ.",
"מֶ\"ב ב:ט-י."
),
seg(8,
...
"Ruach apeinu (Eichah 4:20) = two spirits above. Union = hands opened = spiritual channels flow. To bring from potential to actual: requires shelemut ha'dibur (completeness of speech) = letters of speech in completeness. Source of shelemut: olam ha'ba — in future, speech in completeness; even nations = 'safah berurah' (Tzeph 3:9).",
"\"רוּחַ אַפֵּינוּ\" (אֵיכָה ד:כ) = שְׁנֵי הָרוּחוֹת. אִחוּד → יָדַיִם פְּתוּחוֹת = תְּעָלוֹת פְּתוּחוֹת. לְהוֹצִיא מִכּחַ אֶל הַפּעַל: שְׁלֵמוּת הַדִּבּוּר. מָקוֹר שְׁלֵמוּת: עוֹלָם הַבָּא — \"שָׂפָה בְרוּרָה\" (צְפַנְיָה ג:ט).",
...
"'Ahallela Hashem b'chayai' (Teh 146:2): 'b'chayai' = when not dependent on creatures. Beitzah 32b: one dependent on creatures — 'einan chayav' (not their life). Not dependent = living from own life-force = can praise/pray b'emet. Prayer b'emet requires independence from creatures.",
"\"אֲהַלְלָה ה' בְּחַיָּי\" (תְּהִ' קמו:ב) = כְּשֶׁאֵינוֹ תָּלוּי בִּבְרִיּוֹת. בֵּיצָה לב: הַתָּלוּי בִּבְרִיּוֹת — אֵינָם חַיָּיו. אֵי-תְּלוּת = יָכוֹל לְהִתְפַּלֵּל בֶּאֱמֶת.",
...
"'V'daber davar' (Yesh 58:13) = about Shabbat. Shabbat 113b: speech on Shabbat should not be like weekday speech. Shabbat = aspect of olam ha'ba in time. Drawing Shabbat-speech quality into weekday speech = completing the letters of speech = enabling prayer b'emet.",
"\"וְדַבֵּר דָּבָר\" (יְשַׁ' נח:יג) = עַל שַׁבָּת. שַׁבָּת קי\"ג: שֶׁלֹּא יְהֵא דִּבּוּרְך בְּשַׁבָּת כְּדִבּוּרְך בְּחֹל. שַׁבָּת = בְּחִינַת עוֹלָם הַבָּא. מְשִׁיכַת דִּבּוּר-שַׁבָּת לְתוֹך הַחֹל = הַשְׁלָמַת אוֹתִיּוֹת הַדִּבּוּר.",
...
"Letters complete but must be brought out from 'metzar ha'garon' (straits of throat = exile = Egypt). 'Hoarse' (b'lashon Ashkenaz) = letters stuck without voice. Solution: draw nekudot (vowel points) into the letters. Nekudot = living soul of speech; letters without nekudot = mute/exiled. Nekudot = bring speech out from metzar.",
"אוֹתִיּוֹת הַדִּבּוּר תְּקוּעוֹת בְּ\"מֵצַר הַגָּרוֹן\" (= גָּלוּת מִצְרַיִם). פִּתְרוֹן: מְשִׁיכַת נְקוּדוֹת אֶל הָאוֹתִיּוֹת. נְקוּדוֹת = נֶפֶשׁ חַיָּה שֶׁל הַדִּבּוּר. אוֹתִיּוֹת בְּלִי נְקוּדוֹת = אֱלֶמוֹת.",
...
"All action must pass through speech first: thought → speech → action. Speech = bridge from potential to actual. Completing letters + freeing from throat = opening the gateway of actualization. This applies to prayer too: tefillah must be actual spoken speech, not remain in thought.",
"כָּל מַעֲשֶׂה עוֹבֵר דֶּרֶךְ הַדִּבּוּר: מַחֲשָׁבָה → דִּבּוּר → מַעֲשֶׂה. דִּבּוּר = גֶּשֶׁר בֵּין הַכֹּחַ לַפּחַ וְהַמַּעֲשֶׂה. הַשְׁלָמַת אוֹתִיּוֹת + שְׁחְרוּר מֵהַגָּרוֹן = פְּתִיחַת שַׁעַר הַהַגְשָׁמָה.",
"יְשַׁ' נח:א."
),
seg(13,
...
"Especially: wanting to travel to the true tzaddik. Among all tzaddikim = 'nekudot ha'emet she'ba'tzaddikim.' When wanting to approach the true tzaddik → very many and great meni'ot (preventions). The preventions = proportional to the greatness of the level sought. Severe preventions = sign of great level being sought.",
"בִּמְיוּחָד: רְצוֹן לִנְסוֹעַ לְצַדִּיק הָאֱמִתִּי. בֵּין כָּל הַצַּדִּיקִים = \"נְקוּדוֹת הָאֱמֶת שֶׁבַּצַּדִּיקִים.\" בָּא הָאָדָם לְהִתְקָרֵב → מְנִיעוֹת גְּדוֹלוֹת וְרַבּוֹת. הַמְּנִיעוֹת = פְּרוֹפּוֹרְצְיוֹנָלִיּוֹת לְגֹדֶל הַדַּרְגָּה הַנִּדְרֶשֶׁת.",
"מֶ\"ב ב; זֹהַר."
),
seg(14,
...
"Danger: using prevention as excuse ('I was forced and couldn't come, so it counts'). While Berachot 6a says: 'thought to do mitzvah + coerced = as if done' — this is true in halacha. BUT the purpose of the prevention is to deepen the desire, not to provide an excuse to stay away. Must fight through prevention and actually come.",
"סַכָּנָה: שִׁמּוּשׁ בַּמְּנִיעָה כִּתְרוּץ. בְּרָכוֹת ו: \"חָשַׁב לַעֲשׂוֹת מִצְוָה וְנֶאֱנַס = כְּאִלּוּ עָשָׂה\" — אֱמֶת. אֲבָל מַטָּרַת הַמְּנִיעָה = לְחַזֵּק הַחֵשֶׁק. חַיָּב לְהִתְגַּבֵּר וְלָבוֹא בְּפֹעַל.",
"בְּרָכוֹת ו:."
),
seg(15,
...
"'Va-yered Mitzraimah anoos al pi ha-dibbur' (Dev 26:5 / Haggadah): when speech goes down to 'metzar ha'garon' = exile of Egypt. 'Anoos al pi' = coercion because letters have no nekudot. From this = all preventions/coercions in life. Egypt = straits of speechlessness = letters without nekudot.",
"\"וַיֵּרֶד מִצְרַיְמָה אָנוּס עַל פִּי הַדִּבּוּר\" (דב' כו:ה / הַגָּדָה): דִּבּוּר יוֹרֵד לְ\"מֵצַר הַגָּרוֹן\" = גָּלוּת מִצְרַיִם. \"אָנוּס עַל פִּי\" = אוֹתִיּוֹת בְּלִי נְקוּדוֹת. מִכָּאן: כָּל הַמְּנִיעוֹת וְהָאֳנָסִים.",
...
"Beitzah 32b: dependence on creatures → 'olam machshich lefanav' (world darkens before him). 'Machshich' = language of prevention (meni'ah): Ber 39:9 'v'lo chasach mimeni'; Ber 22:12 'v'lo chasachta et bincha.' Being dependent = prayer surrounded by preventions — cannot pray to Hashem alone. Darkening = dependence = prevention.",
"בֵּיצָה לב: תְּלוּת בִּבְרִיּוֹת → \"עוֹלָם מַחְשִׁיךְ לְפָנָיו.\" \"מַחְשִׁיךְ\" = לְשׁוֹן מְנִיעָה: בְּרֵ' לט:ט; בְּרֵ' כב:יב. תְּלוּת = תְּפִלָּה מוּקֶּפֶת מְנִיעוֹת — לֹא יָכוֹל לְהִתְפַּלֵּל לַה' לְבַדּוֹ.",
...
"One not dependent on creatures: can stand among thousands and pray b'emet to Hashem alone — 'bitachono Hashem Elohav' (Teh 146:5). Independence = condition for true prayer. Berachot 18b: pious man sleeps among graves, hears two spirits speaking about future events (rain, crops). Non-dependence = hearing spirit-speech = accessing higher knowledge.",
"מִי שֶׁאֵינוֹ תָּלוּי בִּבְרִיּוֹת — עוֹמֵד בֵּין אֲלָפִים וּמִתְפַּלֵּל בֶּאֱמֶת לַה' לְבַדּוֹ — \"בִּטְחוֹנוֹ ה' אֱלקָיו\" (תְּהִ' קמו:ה). בְּרָכוֹת י\"ח: חָסִיד שֶׁלָּן בַּבֵּית הַקְּבָרוֹת שָׁמַע שְׁנֵי רוּחוֹת מְדַבְּרוֹת עַל עִנְיְנֵי גֶּשֶׁם וְיְבוּל. אֵי-תְּלוּת = גִּישָׁה לְדִבּוּר הָרוּחוֹת = יְדִיעָה עֶלְיוֹנָה.",
...
"Full resolution: spirit transmission at histalkut → requires presence → enabled by non-dependence. Non-dependence → speech free → letters have nekudot → throat unstuck → prayer b'emet. Shabbat-speech (olam ha'ba) completes letters; non-dependence frees them. Together = standing before Hashem alone = meriting pi shnayim.",
"סִיכּוּם: מַסָּרַת \"פִּי שְׁנַיִם\" בְּהִסְתַּלְּקוּת → דּוֹרֶשֶׁת נוֹכֵחוּת → אֶפְשְׁרִית עַל יְדֵי אֵי-תְּלוּת. אֵי-תְּלוּת → דִּבּוּר חוֹפְשִׁי → אוֹתִיּוֹת עִם נְקוּדוֹת → גָּרוֹן פָּתוּחַ → תְּפִלָּה בֶּאֱמֶת. יַחַד = עֲמִידָה לִפְנֵי ה' לְבַדּוֹ = זְכִיָּה לְ\"פִּי שְׁנַיִם.\"",
...
data = {
    ...
    "part": 1,
    "torah": 66,
    "title": "T66 Petten Nanach Commentary - Pi Shnayim B'Ruchacha (Double Spirit / Spirit Transmission, 18 segs)",
    "hebrewTitle": "יהי נא פי שנים ברוחך אלי — העברת הרוח, שלמות הדיבור, אי-תלות, ותפילה באמת",
...
with open(out_path, encoding='utf-8') as f:
    chk = json.load(f)
assert len(chk['segments']) == 18
avg = sum(len(s['beginner']['en']) for s in chk['segments']) / 18
print(f"Written: {out_path}")
print(f"Segments: 18, avg beginner chars: {avg:.0f}")

lm_path = os.path.join(repo, 'src', 'data', 'lm-commentaries.json')
with open(lm_path, encoding='utf-8') as f:
    cdata = json.load(f)
cdata['1']['66']['running_commentary'] = {
    "book": pnc_name,
    "slug": pnc_name,
    "status": "available",
    "url": f"/reader/{pnc_name}/torah-66.json",
    "layers": ["beginner", "intermediate", "scholarly"],
    "author": "Petten Nanach",
    "label": "Petten Nanach Running Commentary - T66 (Pi Shnayim B'Ruchacha - Spirit Transmission, Speech, Non-dependence, 18 segs)"
}
with open(lm_path, 'w', encoding='utf-8') as f:
    json.dump(cdata, f, ensure_ascii=False, indent=2)
print("lm-commentaries.json updated for T66")

t66_git = 'public/reader/' + pnc_name + '/torah-66.json'
subprocess.run(['git', 'add', 'src/data/lm-commentaries.json', t66_git], cwd=repo, check=True)
r2 = subprocess.run(['git', 'commit', '-m', "feat: T66 PNC -- Pi Shnayim B'Ruchacha (spirit transmission/speech/non-dependence, 18 segs)"], cwd=repo, capture_output=True, text=True)
